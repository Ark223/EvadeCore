...
* **radius** [number] - length of line extending from the center of a  
circle to the circumference or perpendicular offset to a line segment
* **range** [number] - distance from the starting position to ending position
...
* **polygon** [Polygon] - skillshot area constructed from input parameters
